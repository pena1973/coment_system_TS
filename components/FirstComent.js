...
export class FirstComent {
    constructor(userName, msg, foto = "", rating = 0, favorite = false, time = "", id = "") {
        this._msg = "";
        this._userName = "";
        this._foto = "https://placekitten.com/50/50";
        this._rating = 0;
    ...
    render(parent, replase = false) {
        ...
        if (!parent)
            ...
            parent.appendChild(firstComentDom);
